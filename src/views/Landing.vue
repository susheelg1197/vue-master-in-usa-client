            ...
            <div class="row">
              <div class="col-lg-6">
                <h1 class="display-3 text-white">
                  One Stop Repository
                  <span>to pursue your masters dream</span>
                </h1>
                ...
                <base-input
                  placeholder="Type any university, course or state"
        ...
        <div class="row justify-content-center mt--300">
          <div class="col-lg-8">
            <card gradient="secondary" shadow body-classes="p-lg-5">
              <h4 class="mb-1">Write US!</h4>
              <p class="mt-0">Be assured! All your queries will be answered.</p>
              <base-input
                class="mt-5"
                alternative
